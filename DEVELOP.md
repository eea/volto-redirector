...
### Or add @eeacms/volto-redirector to your Volto project
...
1.  Add the following to `mrs.developer.json`:

        {
            "volto-redirector": {
                "output": "packages",
                "url": "https://github.com/eea/volto-redirector.git",
                "package": "@eeacms/volto-redirector",
                "branch": "develop",
                "path": "src"
            }
        }

1.  Add `@eeacms/volto-redirector` to the `addons` key in your project `volto.config.js`
...
project where you added `volto-redirector` to `mrs.developer.json`
...
This will build and start with Docker a clean `Plone backend` and `Volto Frontend` with `volto-redirector` block installed.
